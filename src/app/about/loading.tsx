    ...
    <div className="min-h-screen bg-base" role="status" aria-label="Cargando">
      ...
      <div className="bg-dark-soft py-16 md:py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 text-center">
          <div className="h-10 w-64 mx-auto bg-white/10 animate-shimmer mb-4" />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 mb-16">
          ...
          <div className="aspect-[4/3] bg-base-warm animate-shimmer" />
        </div>

        {/* Values skeleton */}
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
          {Array.from({ length: 3 }).map((_, i) => (
            <div key={i} className="bg-surface p-6 border border-border-light">
              <div className="w-12 h-12 bg-base-warm animate-shimmer mb-4" />
