      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
          ...
          <div className="space-y-5">
            <div className="h-12 bg-surface border border-border-light rounded-xl animate-shimmer" />
            <div className="h-12 bg-surface border border-border-light rounded-xl animate-shimmer" />
            <div className="h-12 bg-surface border border-border-light rounded-xl animate-shimmer" />
            <div className="h-32 bg-surface border border-border-light rounded-xl animate-shimmer" />
          ...
          <div className="space-y-6">
            {Array.from({ length: 3 }).map((_, i) => (
              <div key={i} className="flex gap-4">
                <div className="w-10 h-10 bg-base-warm rounded-xl animate-shimmer shrink-0" />
